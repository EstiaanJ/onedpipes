...
3. [x] **Junction** — 2–3 pipe junction conserves mass and energy to numerical
   tolerance.
4. [x] **Valve/orifice boundary** — steady-state mass flow through the
   boundary matches hand-computed compressible orifice flow for a range
   of pressure ratios.
5. [x] **Sod shock tube** — density/velocity/pressure profiles match the
